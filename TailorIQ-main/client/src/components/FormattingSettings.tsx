...
export default function FormattingSettings({ settings, onSettingsChange }: FormattingSettingsProps) {
    ...
    <div className="h-full w-full bg-white">
      <Tabs defaultValue="formatting" className="w-full">
        ...
        <TabsContent value="templates" className="mt-0">
          <div className="p-4">
            <p className="text-gray-500">Template options will go here</p>
          </div>
        </TabsContent>
        
        <TabsContent value="formatting" className="mt-0">
          <div className="p-4">
            <h2 className="text-xl font-semibold mb-6">Text Formatting</h2>
        ...
        <TabsContent value="export" className="mt-0">
          <div className="p-4">
            <p className="text-gray-500">Export options will go here</p>
          </div>
        </TabsContent>
      </Tabs>
    </div>
