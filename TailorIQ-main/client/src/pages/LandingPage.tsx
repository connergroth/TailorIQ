          ...
          >
            {[
              ...
              <motion.div 
                key={index}
                variants={scaleIn}
                className="text-center p-6 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700"
              >
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                {index < steps.length - 1 && (
                  <div className="hidden lg:block absolute top-1/4 right-0 w-full h-0.5 bg-gray-200 dark:bg-gray-700" style={{ width: 'calc(100% - 2rem)', left: 'calc(100% - 1rem)' }}></div>
                )}
              </motion.div>
            ))}
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center mb-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-12 gap-y-4 text-center md:text-left">
              ...
              <a href="#" className="hover:text-brand-indigo dark:hover:text-indigo-400 transition-colors duration-300">Privacy Policy</a>
              <a href="#" className="hover:text-brand-indigo dark:hover:text-indigo-400 transition-colors duration-300">Terms of Service</a>
              <a href="#" className="hover:text-brand-indigo dark:hover:text-indigo-400 transition-colors duration-300">Contact</a>
            </div>
          </div>
