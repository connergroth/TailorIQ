...
const Logo = ({ darkMode }: { darkMode: boolean }) => {
  return (
    <div className="flex items-center space-x-2">
      <div className={`p-2 rounded-lg ${darkMode ? 'bg-gray-800' : 'bg-indigo-50'} transition-all duration-300`}>
...
const LandingPage: React.FC<LandingPageProps> = ({ darkMode, toggleDarkMode }) => {
  ...
  const Navbar = () => {
    return (
      <nav className={`fixed top-0 left-0 right-0 z-50 py-4 transition-all duration-300 
        ${isScrolled ? 
          (darkMode ? 'bg-gray-900/90 backdrop-blur-md shadow-md' : 'bg-white/90 backdrop-blur-md shadow-md') : 
          'bg-transparent'}`}
      >
        ...
        {mobileMenuOpen && (
          <motion.div 
            ...
            exit={{ opacity: 0, y: -10 }}
            className={`md:hidden ${darkMode ? 'bg-gray-900/95 backdrop-blur-md' : 'bg-white/95 backdrop-blur-md'} transition-colors duration-300 py-4 shadow-xl`}
          >
            <div className="container mx-auto px-4 space-y-4">
              <a href="#features" onClick={(e) => {
                smoothScroll(e, 'features');
                setMobileMenuOpen(false);
              }} className={`block py-3 px-4 rounded-md hover:bg-gradient-to-r ${darkMode ? 'from-gray-800 to-gray-800 text-gray-300' : 'from-gray-100 to-gray-100 text-gray-700'} transition-colors duration-300`}>Features</a>
              <a href="#how-it-works" onClick={(e) => {
                smoothScroll(e, 'how-it-works');
                setMobileMenuOpen(false);
              }} className={`block py-3 px-4 rounded-md hover:bg-gradient-to-r ${darkMode ? 'from-gray-800 to-gray-800 text-gray-300' : 'from-gray-100 to-gray-100 text-gray-700'} transition-colors duration-300`}>How It Works</a>
              <a href="#why-tailoriq" onClick={(e) => {
                smoothScroll(e, 'why-tailoriq');
                setMobileMenuOpen(false);
              }} className={`block py-3 px-4 rounded-md hover:bg-gradient-to-r ${darkMode ? 'from-gray-800 to-gray-800 text-gray-300' : 'from-gray-100 to-gray-100 text-gray-700'} transition-colors duration-300`}>Why TailorIQ</a>
              {!currentUser && (
                <a 
                  href="#" 
                  onClick={(e) => {
                  ...
                  className={`block py-3 px-4 rounded-md hover:bg-gradient-to-r ${darkMode ? 'from-gray-800 to-gray-800 text-gray-300' : 'from-gray-100 to-gray-100 text-gray-700'} transition-colors duration-300`}
                >
                  Log In
                </a>
              )}
  ...
  const Hero = () => {
    return (
      <section 
        className={`pt-32 pb-20 ${darkMode ? 'bg-hero-pattern-dark bg-gray-900 text-white' : 'bg-hero-pattern-light bg-white text-gray-900'} transition-colors duration-300`}
      >
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <a 
                  ...
                  className={`flex items-center justify-center px-8 py-6 rounded-md border text-lg group hover:shadow-md ${
                    darkMode 
            ...
            >
              <div className="glass-card rounded-xl overflow-hidden shadow-2xl border border-indigo-500/20">
                ...
                <motion.div 
                  className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-6`}
                  variants={fadeInUp}
                >
          ...
          >
            {[
              ...
              <motion.div 
                key={index}
                variants={scaleIn}
                className={`text-center p-6 rounded-lg ${darkMode ? 'bg-gray-800/50' : 'bg-gray-50'} border ${darkMode ? 'border-gray-700' : 'border-gray-200'}`}
              >
  ...
  const Features = () => {
    ...
    return (
      <section 
        id="features" 
        className={`py-20 ${darkMode ? 'bg-gray-800 text-white' : 'bg-gray-50 text-gray-900'} transition-colors duration-300`}
      >
        <div className="container mx-auto px-4">
          <motion.div 
            initial="hidden"
          ...
          >
            ...
            <p className={`max-w-2xl mx-auto ${darkMode ? 'text-gray-300' : 'text-gray-600'} text-lg`}>
  ...
  const HowItWorks = () => {
    ...
    return (
      <section 
        id="how-it-works" 
        className={`py-24 ${darkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'} transition-colors duration-300`}
      >
        <div className="container mx-auto px-4">
          <motion.div 
            initial="hidden"
          ...
          >
            {steps.map((step, index) => (
              <motion.div 
                ...
                className="relative"
              >
                <div className={`text-7xl font-bold ${darkMode ? 'text-brand-indigo opacity-20' : 'text-indigo-100'} absolute -top-10 left-0`}>
                  {step.number}
                </div>
                ...
                {index < steps.length - 1 && (
                  <div className={`hidden lg:block absolute top-1/4 right-0 w-full h-0.5 ${darkMode ? 'bg-gray-700' : 'bg-gray-200'}`} style={{ width: 'calc(100% - 2rem)', left: 'calc(100% - 1rem)' }}></div>
                )}
              </motion.div>
            ))}
          </motion.div>
  ...
  const WhyTailorIQ = () => {
    return (
      <section 
        id="why-tailoriq" 
        className={`py-24 ${darkMode ? 'bg-gray-800 text-white' : 'bg-gray-50 text-gray-900'} transition-colors duration-300`}
      >
        <div className="container mx-auto px-4">
          <motion.div 
            initial="hidden"
              ...
              <div className="glass-card p-8 rounded-xl shadow-2xl relative overflow-hidden border-t border-white/20">
                ...
                <div className="space-y-6 relative z-10">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <div className="font-bold text-lg">Ronan Healy</div>
                      <div className={`${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Software Engineer</div>
                    </div>
                  </div>
  ...
  const Footer = () => {
    ...
    return (
      <footer className={`py-16 ${darkMode ? 'bg-gray-900 text-gray-400' : 'bg-white text-gray-600'} transition-colors duration-300`}>
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center mb-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-12 gap-y-4 text-center md:text-left">
              <a href="#features" onClick={(e) => smoothScroll(e, 'features')} className="hover:text-brand-indigo transition-colors duration-300">Features</a>
              <a href="#how-it-works" onClick={(e) => smoothScroll(e, 'how-it-works')} className="hover:text-brand-indigo transition-colors duration-300">How It Works</a>
              <a href="#why-tailoriq" onClick={(e) => smoothScroll(e, 'why-tailoriq')} className="hover:text-brand-indigo transition-colors duration-300">Why TailorIQ</a>
              <a href="#" className="hover:text-brand-indigo transition-colors duration-300">Privacy Policy</a>
              <a href="#" className="hover:text-brand-indigo transition-colors duration-300">Terms of Service</a>
              <a href="#" className="hover:text-brand-indigo transition-colors duration-300">Contact</a>
            </div>
          </div>
          ...
          <div className={`pt-8 border-t ${darkMode ? 'border-gray-800' : 'border-gray-200'} flex flex-col md:flex-row justify-between items-center`}>
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="#" className={`${darkMode ? 'text-gray-400 hover:text-white' : 'text-gray-600 hover:text-gray-900'} transition-colors duration-300`}>
