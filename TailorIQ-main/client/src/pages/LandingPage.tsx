      ...
      >
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="max-w-2xl mx-auto text-gray-600 dark:text-gray-300 text-lg">
            Since AI already parses your resume, why not let AI optimize it too?<br />
            Stand out from the competition with our cutting-edge resume creation.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="pt-8 border-t border-gray-200 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a href="https://github.com/connergroth/tailoriq" className="text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors duration-300">
